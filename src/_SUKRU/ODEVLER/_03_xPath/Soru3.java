...
//       Not: Bu yazıdaki sayı değişiklik gösterebilir. Önemli olan cümle kalıbı.
            ...
            WebElement el1=driver.findElement(By.xpath("//input[contains(@class, 'col-xs-20')]"));
            el1.sendKeys("teddy bear");

            WebElement el2=driver.findElement(By.xpath("//button[contains(@class, 'searchformButton')]"));

            Bekle(3);
            el2.click();

            WebElement el3=driver.findElement(By.xpath("//div[@id='searchMessageContainer']//span"));
